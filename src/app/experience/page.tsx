      ...
      <main className="max-w-3xl mx-auto space-y-6">
        ...
        <section className="border border-slate-200 bg-white p-6 relative group transition-colors hover:border-slate-300">
          ...
          <p className="text-sm text-slate-700 leading-relaxed mb-4">
            Dans le cadre de mon alternance en 3e année de BUT MMI, j'ai intégré
            l'équipe Kimind pour crée et modifié des agents IA sur la plateforme
            Dust. Mon rôle nécessite pragmatisme, rigueur et une forte
            sensibilité à la GenAI.
          </p>
        </section>
        ...
        <section className="border border-slate-200 bg-white p-6 relative group transition-colors hover:border-slate-300">
          ...
          <ul className="list-none space-y-3 text-sm text-slate-700">
            ...
            <li className="flex gap-3">
              <span className="text-cyan-500">&gt;</span> Création d'agents IA.
            </li>
            <li className="flex gap-3">
              <span className="text-cyan-500">&gt;</span> Miniature vidéo pour
              Linguosphère.
            </li>
            <li className="flex gap-3">
              <span className="text-cyan-500">&gt;</span> Page wordpress pour
              Kimind.
            </li>
          </ul>
        </section>
